...
public class WorkflowApiYamlWriterTests
{
    [Fact]
    ...
    public void Omits_null_and_empty()
    {
        ...
        Assert.DoesNotContain("info:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("bindings:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("activities:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("bridges:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("diagnostics:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("displayName:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("summary:", yaml, StringComparison.Ordinal);
        Assert.DoesNotContain("$ref", yaml, StringComparison.Ordinal);
    }
    ...
    private static string Write(WorkflowApiDocument document) =>
        WorkflowApiYamlWriter.Write(document);
}
